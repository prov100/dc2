...
//const (
//defaultConfigFile = "internal/config/development.yaml"
...
func (h *WfHelper) StartWorkflow(
	...
	fmt.Println("common/wf_helper.go StartWorkflow")
...
func (h *WfHelper) StartWorkflowWithCtx(
	...
	fmt.Println("common/wf_helper.go StartWorkflow StartWorkflowWithCtx")
	fmt.Println("common/wf_helper.go StartWorkflow StartWorkflowWithCtx err", err)
	if err != nil {
	...
	fmt.Println("common/wf_helper.go StartWorkflow StartWorkflowWithCtx StartWorkflow we", we)
	fmt.Println("common/wf_helper.go StartWorkflow StartWorkflowWithCtx StartWorkflow weerr", err)
	if err != nil {
		h.Logger.Error("Failed to create workflow", zap.Error(err))
		panic("Failed to create workflow.")
	} else {
		fmt.Println("common/wf_helper.go StartWorkflow StartWorkflowWithCtx StartWorkflow WorkflowID", we.ID)
		fmt.Println("common/wf_helper.go StartWorkflow StartWorkflowWithCtx StartWorkflow RunID", we.RunID)
